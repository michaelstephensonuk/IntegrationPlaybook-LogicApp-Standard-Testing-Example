...
namespace logicapp.testing.acceptancetests.Features.Dataverse_WhoAmI_Tests
{
    ...
    public partial class DataverseWhoAmIFeature
    {
...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Dataverse Who Am I")))
            {
                global::logicapp.testing.acceptancetests.Features.Dataverse_WhoAmI_Tests.DataverseWhoAmIFeature.FeatureSetup(null);
            }
        }
